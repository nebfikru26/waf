...
export default function AnalyticsPage() {
  ...
  const overviewStats = [
    ...
    },
    {
      ...
      change: summary?.source === "elasticsearch" ? "ES Backed" : "Postgres",
      up: true,
      icon: Shield,
      color: "text-red-400",
    },
    ...
    <DashboardLayout>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              {summary?.source === "elasticsearch"
                ? "⚡ Powered by Elasticsearch — live telemetry pipeline"
                : "📊 Powered by PostgreSQL — connect Elasticsearch for real-time streaming"}
            </p>
          </div>
      ...
      {isLocked && (
        <UpgradeOverlay 
          ...
          description="Unlock deep insights into your traffic with live telemetry pipelines, Elasticsearch-backed search, and comprehensive threat distribution maps. This feature requires the Professional plan."
          feature="Analytics"
        />
      )}
    </DashboardLayout>
